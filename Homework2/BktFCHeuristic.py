...
class SudokuSolverMRV:
    ...
    def MRVMethod(self):
        ...
        return min(variableList, key=lambda cell: len(self.validValues(cell[0], cell[1])))
...
if __name__ == "__main__":
    ...
    solver = SudokuSolverMRV(assignment)
    if solver.BktFCmrv():
        print("Solutia Sudocu cu Forward Checking MRV :")
        solver.printRes()
    else:
