...
class NeuralNetwork:
    ...
    def backward_propagation(self, X, Y, cache):
        ...
        dZ1 = np.dot(self.W2.T, dZ2) * (1 - np.power(cache["A1"], 2))
...
# Transpose the data for neural network training
...
hidden_size = 4
output_size = 1
neural_net = NeuralNetwork(input_size, hidden_size, output_size, learning_rate=0.01)
